                    ...
                    <div className="col-lg-8 col-lg-12">
                        <div className="blog-details-desc">
                            ...
                            <div className="article-content">
                                ...
                                (VM) in a layer abstracted from the actual hardware. Moreover, we usually 
                                use virtualization to run multiple independent operating systems on one 
                                physical computer. Essentially it is the process of creating a simulated 
                                ...
                                <ul>
                                    ...
                                    <li>Guest OS, which is used interchangeably for the virtual machine as a machine usually 
                                ...
                                <p>This refers to running one or more virtual machines on a personal or workstation 
                                which can also be referred to in the IT community as a thick client. Typically this is 
                                ...
                                of visualization later here). There are two cases where this can be extremely useful:</p>
                                ...
                                <ol>
                                    <li>
                                        ...
                                        when it is important to maintain backward compatibility while pushing new software 
                                        updates.
                                    </li>

                                    <li>
                                        Using software that is not available for your operating system whether it is 
                                        business applications of games. However, it is important to note that Mac virtual 
                                ...
                                very powerful computer that provides functionality for other programs or devices 
                                ...
                                refers to the fact that we can allocate pieces of ower host machine to the guest machines. 
                                ...
                                <p>
                                    ...
                                    machine, to this guest OS it will appear as if it is one Hardware. For example, if we 
                                    allocate 2GB of RAM to a guest OS, it will appear to it that it has 2GR of RAM as if 
                                    it was its own hardware.  The same idea applies if we allocate 1 core of the CPU and 
                                    other physical resources.
                                </p>
                                <p>
                                    Another purpose for the use of virtualization but in this case only for cloud services, 
                                    is rapid scalability. As it allows the company to expand its resources much 
                                    faster and at a much lower cost. This applies both for scaling vertically, which 
                                    means expanding the hardware capabilities of the VM’s and horizontally which 
                                    means expanding the number of VM's or computing instances. This will be explained 
                                    in more detail in the section on cloud computing features.
                                </p>
                                ...
                                <p>
                                    ...
                                    where it is possible to host multiple another guest OS’s, the VM’s are isolated from each 
                                    other and from the host. Meaning that to each guest Os it appears as it if it has it's 
                                ...
                                <p>
                                    ...
                                    machines possible. They are software that allows for the creation of these 
                                    virtual machines as well as allows communication between the host OS and 
                                    the guest OS. However, it is important to notw that not all hypervisors are the 
                                ...
                                systems as it provided a very cheap way for users to experiment. Some common examples of 
                                this type are: 
                                </p>
                                ...
                                to run software that was designed for a specific and different piece of hardware. It is 
                                commonly used for printers so that they emulate and HP LasorJet and are able to use it's 
                                software. However, it is also typically used by game enthusiasts which want to play classic 
                                ...
                                <ol>
                                    ...
                                    <p>It is an application run remotely, typically over a browser and most of us make use of 
                                    them every day whether we are aware of them or not and many of them are free. Some 
                                    examples are:</p>
                                    <ul>
                                        <li>Gmail</li>
                                        <li>Google Drive</li>
                                    ...
                                    <p>
                                        This model provides the user with an environment for the development of the application. Some PaaS examples are: 
                                    </p>
                                    <ul>
                                        <li>Heroku</li>
                                        <li>GitHub</li>
                                    ...
                                    <p>In this model, the user has much more flexibility as to how he uses the services, 
                                    ...
                                    <ol>
                                        <li>Public</li>
                                        <p>It is by fare the most common and it is as the name suggests cloud vendor that offers 
                                        it services publicly and therefore everyone has access to them. Some common examples are:</p>
                                        <ul>
                                            <li>AWS</li>
                                            <li>Google Cloud</li>
                                            <li>Microsoft Azure</li>
                                        ...
                                        security as you have more control over how your data is handled and backed up. It is often 
                                        ...
                                        rest of your computing requirements to a public cloud.</p>
                                        <li>Community</li>
                                ...
                                <p>There are a couple of defining features of cloud computing that can have a massive advantage to your organization. 
                                ...
                                <ol>
                                    ...
                                    <li>On demand</li>
                                    <p>This refers to the fact that the resources are available whenever you need them and can be obtained 
                                    extremely fast.</p>
